...
background-color:${props => props.theme.textr};
...
const Banner = () => {
    return(
        <Section>
            <ImgContainer>
                <img src={png1} alt="The Weirdos" />
                <img src={png2} alt="The Weirdos" />
                <img src={png3} alt="The Weirdos" />
                <img src={png4} alt="The Weirdos" />
                <img src={png5} alt="The Weirdos" />
            </ImgContainer>
